...
async def lifespan(app: FastAPI):
    global db_pool
    print("Application startup: Creating database connection pool...")
    try:
...
app = FastAPI(title="AD Server and Feedback Handler",lifespan=lifespan)
